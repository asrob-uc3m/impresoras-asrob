 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 10     // Degrees Celsius -DEDALO
   ...
   */
  #define WATCH_TEMP_PERIOD 60                // Seconds - DEDALO
  #define WATCH_TEMP_INCREASE 1               // Degrees Celsius - DEDALO
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 60    // Seconds - DEDALO
  ...
  #define WATCH_BED_TEMP_INCREASE 1               // Degrees Celsius - DEDALO
#endif

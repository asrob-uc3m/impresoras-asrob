//FICHERO DE CONFIGURACIÓN AVANZADA MARLIN FIRMWARE
...
//===========================================================================
  ...
  #define BED_HYSTERESIS 2 //only disable heating if T>target+BED_HYSTERESIS and enable heating if T>target-BED_HYSTERESIS //HIJA_RESURRECTION
#endif
#define BED_CHECK_INTERVAL 500 //ms between checks in bang-bang control //HIJA_RESURRECTION

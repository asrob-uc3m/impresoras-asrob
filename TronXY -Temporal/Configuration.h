...
#define CUSTOM_MACHINE_NAME "Decidid ya el nombre!"
...
#define TEMP_RESIDENCY_TIME 60  // (seconds) #TRONXY
#define TEMP_HYSTERESIS 10      // (degC) range of +/- temperatures considered "close" to the target one #TRONXY
